...
hold on
g60 = scatter(TimeVec,UntreatedTotal,60,ColorMatrix(1, :),'o','filled'); %,'20', [33,102,172]/255,'*');
hold on
g1 = scatter(TimeVec([3,4]),DocetaxelTotal([3,4]),40,ColorMatrix(2, :),'s','LineWidth',1.85);
hold on
